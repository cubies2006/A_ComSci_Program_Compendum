...
public class CubiesMenu extends Canvas
{
	...
	protected void paint(Graphics g)
	{
	    if (MenuStatus == 1)
		{
			g.drawImage(menuBackground, this.getWidth() / 245, this.getHeight() / 300, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesNewGameHlite, 13, 80, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesHighScores, 13, 100, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesSettings, 13, 120, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesInstructions, 13, 140, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesExitGame, 13, 160, Graphics.TOP|Graphics.LEFT);
		}
		else if (MenuStatus == 2)
		{
			g.drawImage(menuBackground, this.getWidth() / 245, this.getHeight() / 300, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesNewGame, 13, 80, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesHighScoresHlite, 13, 100, Graphics.TOP|Graphics.LEFT);;
			g.drawImage(CubiesSettings, 13, 120, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesInstructions, 13, 140, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesExitGame, 13, 160, Graphics.TOP|Graphics.LEFT);
		}
		else if(MenuStatus == 3)
		{
			...
			g.drawImage(CubiesNewGame, 13, 80, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesHighScores, 13, 100, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesSettingsHlite, 13, 120, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesInstructions, 13, 140, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesExitGame, 13, 160, Graphics.TOP|Graphics.LEFT);
		}
		else if (MenuStatus == 4)
		{
			...
			g.drawImage(CubiesHighScores, 13, 100, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesSettings, 13, 120, Graphics.TOP|Graphics.LEFT);
		    g.drawImage(CubiesInstructionsHlite, 13, 140, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesExitGame, 13, 160, Graphics.TOP|Graphics.LEFT);
		}
		else if (MenuStatus == 5)
		{
			...
			g.drawImage(CubiesSettings, 13, 120, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesInstructions, 13, 140, Graphics.TOP|Graphics.LEFT);
			g.drawImage(CubiesExitGameHlite, 13, 160, Graphics.TOP|Graphics.LEFT);
		}		
	}
