/*This example demonstrates how to create various GUI components. 
The MIDlet for this example allows you to test lists, forms, choices, 
gauges, text fields, text boxes, for example.*/

import javax.microedition.lcdui.*;
import javax.microedition.midlet.*;

public class GUITest extends MIDlet implements CommandListener 
{
	// display manager
