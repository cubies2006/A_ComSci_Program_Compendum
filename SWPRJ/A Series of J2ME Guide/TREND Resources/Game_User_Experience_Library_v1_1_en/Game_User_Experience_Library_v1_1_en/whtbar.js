...
function openFN()
{
	top.location = "http://www.forum.nokia.com/"
}
...
function addBanner(sImage)
{
	...
	{
		var nBtn=gaButtons.length;
		gaButtons[nBtn]="<td NOWRAP align=\"center\" valign=\"middle\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:openFN();\" ><img alt=\"Visit Forum Nokia Web site\"src=\""+sImage+"\" border=0 align=\"absmiddle\"></a></td>";
		gaTypes[nBtn]="banner";
	}
}
