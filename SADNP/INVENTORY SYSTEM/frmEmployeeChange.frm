...
Begin VB.Form frmEmployeeChange 
   Caption         =   "Change Employee Password"
   ClientHeight    =   4890
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4800
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmEmployeeChange.frx":0000
   ScaleHeight     =   4890
   ScaleWidth      =   4800
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frmEmployeeChange.frx":A207
      OLEDBString     =   $"frmEmployeeChange.frx":A29D
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
   ...
   Begin VB.CommandButton cmdBack 
      ...
      Height          =   855
      Left            =   3360
      Picture         =   "frmEmployeeChange.frx":A333
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Back to Employee Login"
      Top             =   3720
      Width           =   1095
   End
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   855
      Left            =   1800
      Picture         =   "frmEmployeeChange.frx":A3EE
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Height          =   855
      Left            =   360
      Picture         =   "frmEmployeeChange.frx":A468
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.TextBox txtUN 
      ...
      Left            =   1560
      TabIndex        =   1
      ToolTipText     =   "Type your Employee No. here"
      Top             =   720
      Width           =   1935
   End
   ...
   End
End
Attribute VB_Name = "frmEmployeeChange"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub cmdBack_Click()
    frmEmployeeChange.Hide
...
Else
    ...
    Else
        ...
        Adodc1.RecordSource = "Select * from Employeesecurity Where Password like '" & txtOld.Text & "' and EmpNo like '" & txtUN.Text & "'"
        Call Adodc1.Refresh
