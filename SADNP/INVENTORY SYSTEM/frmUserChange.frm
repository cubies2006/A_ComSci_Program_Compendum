...
Begin VB.Form frmUserChange 
   ...
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   Picture         =   "frmUserChange.frx":0000
   ScaleHeight     =   4920
   ScaleWidth      =   4890
   ...
   Begin VB.TextBox txtUN 
      ...
      Left            =   1560
      TabIndex        =   0
      ToolTipText     =   "Type your User ID here"
      Top             =   720
      Width           =   1935
   End
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Height          =   855
      Left            =   360
      Picture         =   "frmUserChange.frx":A207
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   855
      Left            =   1800
      Picture         =   "frmUserChange.frx":A2DE
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmdBack 
      ...
      Height          =   855
      Left            =   3360
      Picture         =   "frmUserChange.frx":A358
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Back to User Login"
      Top             =   3720
      Width           =   1095
   End
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\INVENTORY SYSTEM\Inventory_System.mdb;Persist Security Info=False"
      OLEDBString     =   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\INVENTORY SYSTEM\Inventory_System.mdb;Persist Security Info=False"
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   """select * from usersecurity"""
...
Else
    ...
    Else
        ...
        Adodc1.RecordSource = "Select * from Usersecurity Where Password like '" & txtOld.Text & "' and UserID like '" & txtUN.Text & "'"
        Call Adodc1.Refresh
